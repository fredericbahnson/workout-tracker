    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          You have {completedCount} completed workout{pluralSuffix} in this cycle.
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Keep your {completedCount} completed workout{pluralSuffix} and apply changes to remaining workouts
            </p>
          </button>
