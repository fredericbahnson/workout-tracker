/**
 * TapToEditSlide Component
 *
 * Interactive slide where user practices the tap-to-edit gesture.
...
interface TapToEditSlideProps {
  onComplete: () => void;
}

export function TapToEditSlide({ onComplete }: TapToEditSlideProps) {
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-12">
        ...
        <p
          ...
          `}
        >
          Tap any set to log a different number of reps or time.
        </p>
        ...
        <p
          ...
          `}
        >
          Perfect for when you hit more or fewer reps than expected
        </p>
      </div>
    </div>
  );
