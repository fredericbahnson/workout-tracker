# Ascend v2.11.0 Deployment Instructions
...
- Collapsible section showing all working sets (excludes warmups)
...
```
Tests:  243 passed (up from 237)
Files:  7 test files
New:    6 tests for getWorkingSetHistory()
...
rm -rf src docs
unzip ~/Downloads/ascend-v2.11.0.zip -d temp && \
...
# Deploy
git add .
git commit -m "v2.11.0: Add Exercise History feature
...
- [ ] Version displays as v2.11.0 in Settings tab
