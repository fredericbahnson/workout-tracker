...
- ✅ Cycle wizard layout issue - FIXED in v2.7.5 (not in original review)
...
### 5.4 Cycle Wizard Layout — ✅ FIXED (v2.7.5)

**Status:** ✅ RESOLVED

**Issue:** In cycle creation wizard, conditioning exercises had inline input fields that squeezed exercise names into narrow columns on mobile.
...
| v2.7.5 | 5.4 - Cycle wizard layout fix, 4.4 - Removed deprecated prop |
...
### Already Completed (v2.7.4 + v2.7.5)
```
src/constants/units.ts (new)
